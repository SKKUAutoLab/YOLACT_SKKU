...
```
```Shell
python eval.py --trained_model=weights/"path to trained weight".pth --score_threshold=0.15 --top_k=15 --image=data/test.jpg:output_image.png
```
...
# EXAMPLE training with Lightweight backbone
python train.py --config=yolact_mobilenetv2_custom_lane_config
```
